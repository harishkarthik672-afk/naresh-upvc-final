...
def update_html_headers():
    public_dir = "public"
    # New block including favicon.ico AND explicit PNG links for Google
    favicon_html = """
    ...
    for filename in os.listdir(public_dir):
        if filename.endswith(".html"):
            ...
            for line in lines:
                ...
                if 'rel="icon"' in lower_line or 'rel="shortcut icon"' in lower_line or 'rel="apple-touch-icon"' in lower_line or 'site.webmanifest' in lower_line:
                    continue 
                if 'name="theme-color"' in lower_line:
                    continue
